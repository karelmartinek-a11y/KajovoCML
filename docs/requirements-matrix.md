...
| Database migrations | checksum ledger and advisory-locked runner | canonical 001-018 ledger plus hashed archive of superseded pre-ledger 007-014; 017-018 add only the compatibility managed-service model and backfill | clean, production-ledger upgrade, idempotency, changed/late migration rejection |
