...
function MonitoringPage({
  ...
  return (
    <>
      ...
      {detailServer ? <ServerDetailModal server={servers.find((server) => server.id === detailServer.id) ?? detailServer} onClose={() => setDetailServer(null)} /> : null}
    </>
  );
}
