...
cp apps/server/src/generation/runtime-host.mjs apps/server/src/generation/runtime-probe.mjs apps/server/src/generation/handler-sandbox.mjs apps/server/src/generation/handler-sandbox-worker.mjs apps/server/src/generation/browser-session.mjs apps/server/src/generation/playwright-session.mjs apps/server/src/generation/browser-automation-runtime.mjs apps/server/src/generation/generation-cancellation.mjs apps/server/src/generation/external-http-capability.mjs apps/server/src/generation/integration-phase.mjs apps/server/src/generation/generation-secret-plan.mjs apps/server/src/generation/provider-secret-capability.mjs apps/server/src/generation/generation-release-cleanup.mjs apps/server/src/generation/generation-failure-recovery.mjs apps/server/src/generation/generation-secret-grant-control.mjs "$destination/apps/server/dist/generation/"
