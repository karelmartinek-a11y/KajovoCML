...
require_file "$tmpdir/release/apps/server/dist/cli/ssot-production-acceptance.js"
...
require_executable "$tmpdir/release/deploy/scripts/run-production-acceptance.sh"
require_executable "$tmpdir/release/deploy/scripts/run-wedos-infrastructure-acceptance.sh"
require_executable "$tmpdir/release/deploy/scripts/run-webhook-infrastructure-acceptance.sh"
...
require_text 'dist/cli/ssot-production-acceptance.js' "$tmpdir/release/deploy/scripts/run-production-acceptance.sh"
