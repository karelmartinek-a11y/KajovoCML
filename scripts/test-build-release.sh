...
test -f "$tmpdir/release/docs/onboarding-catalogs/mcp-1.7.json"
test -f "$tmpdir/release/Connect_in_Catalog_KajovoMCPCML_v1.7.docx"
...
mcp_manifest_path="$(jq -r '.manifestExamplePath' "$tmpdir/release/docs/onboarding-catalogs/mcp-1.7.json")"
