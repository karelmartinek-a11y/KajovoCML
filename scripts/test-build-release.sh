...
test -f "$tmpdir/release/docs/onboarding-catalogs/onboarding-1.1.json"
...
mcp_manifest_path="$(jq -r '.manifestExamplePath' "$tmpdir/release/docs/onboarding-catalogs/onboarding-1.1.json")"
external_manifest_path="$(jq -r '.manifestExamplePath' "$tmpdir/release/docs/onboarding-catalogs/external-api-1.0.json")"
test "$(jq -r '.identityAssignment.hostnamePattern' "$tmpdir/release/docs/onboarding-catalogs/onboarding-1.1.json")" = "kcml####.kajovocml.hcasc.cz"
