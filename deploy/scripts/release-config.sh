...
case "$action" in
  ...
  restore)
    ...
    systemctl stop kcml kcml-generation-worker kcml-component-control-worker kcml-component-e2e-worker kcml-monitor kcml-egress-proxy kcml-alert-primary kcml-alert-backup 2>/dev/null || true
    ...
    for unit in kcml kcml-generation-worker kcml-component-control-worker kcml-component-e2e-worker kcml-monitor kcml-egress-proxy kcml-alert-primary kcml-alert-backup; do
