...
managed_paths=(
  ...
  etc/systemd/system/kcml-generation-worker.service
  etc/systemd/system/kcml-browser-automation-worker.service
  etc/systemd/system/kcml-generated-component@.service
...
case "$action" in
  ...
  systemctl stop kcml kcml-generation-worker kcml-browser-automation-worker kcml-component-control-worker kcml-component-e2e-worker kcml-monitor kcml-egress-proxy kcml-alert-primary kcml-alert-backup 2>/dev/null || true
    ...
    for unit in kcml kcml-generation-worker kcml-browser-automation-worker kcml-component-control-worker kcml-component-e2e-worker kcml-monitor kcml-egress-proxy kcml-alert-primary kcml-alert-backup; do
