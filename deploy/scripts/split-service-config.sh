...
write_env "$root/web.env" \
  NODE_ENV PORT BUILD_ID CONFIG_VAULT_MASTER_KEY_ID PUBLIC_BASE_DOMAIN ADMIN_HOST AUTH_HOST REGISTER_HOST EGRESS_PROXY_SOCKET_PATH WILDCARD_TLS_CERT_PATH TRUSTED_PROXY_CIDRS LOG_LEVEL UI_TIME_ZONE
